import "./hostInit-Du_sL6LL.js";
import { i as index_cjs, h as host_mf_2_app__mf_v__runtimeInit__mf_v__ } from "./virtual_mf-REMOTE_ENTRY_ID-DKq_Mz23.js";
...
const { initPromise: initPromise$1 } = host_mf_2_app__mf_v__runtimeInit__mf_v__;
const res$1 = initPromise$1.then((_) => loadRemote$1("header-mfe"));
const exportModule$1 = await initPromise$1.then((_) => res$1);
var host_mf_2_app__loadRemote__header_mf_2_mfe__loadRemote__ = exportModule$1;
function HeaderWrapper(props) {
  const { children } = props;
  const placeholderRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    host_mf_2_app__loadRemote__header_mf_2_mfe__loadRemote__.render(placeholderRef.current);
  }, []);
...
const res = initPromise.then((_) => loadRemote("table-mfe"));
const exportModule = await initPromise.then((_) => res);
var host_mf_2_app__loadRemote__table_mf_2_mfe__loadRemote__ = exportModule;
function TableWrapper(props) {
  const { children } = props;
  const placeholderRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    host_mf_2_app__loadRemote__table_mf_2_mfe__loadRemote__.render(placeholderRef.current);
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: placeholderRef, children });
}
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.header, children: /* @__PURE__ */ jsxRuntimeExports.jsx(HeaderWrapper, {}) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.body, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      reactExports.Suspense,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableWrapper, {})
      }
    ) })
  ] });
}
