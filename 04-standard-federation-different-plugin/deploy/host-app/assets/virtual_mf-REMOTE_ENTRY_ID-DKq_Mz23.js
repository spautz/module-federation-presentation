...
const usedRemotes = [
  {
    entryGlobalName: "header-mfe",
    name: "header-mfe",
    type: "module",
    entry: "http://localhost:3004/header-mfe/assets/remoteEntry-header.js"
  },
  {
    entryGlobalName: "table-mfe",
    name: "table-mfe",
    type: "module",
    entry: "http://localhost:3004/table-mfe/assets/remoteEntry-table.js"
  }
];
...
var host_mf_2_app__mf_v__runtimeInit__mf_v__ = {
  initPromise,
  initResolve,
  initReject
};
async function init(shared = {}) {
  ...
  host_mf_2_app__mf_v__runtimeInit__mf_v__.initResolve(initRes);
  return initRes;
}
...
export {
  init as a,
  getExposes as g,
  host_mf_2_app__mf_v__runtimeInit__mf_v__ as h,
  index_cjs$1 as i
};
