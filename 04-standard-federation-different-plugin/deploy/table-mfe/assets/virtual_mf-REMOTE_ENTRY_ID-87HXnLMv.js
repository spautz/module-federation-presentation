import { _ as __vitePreload, e as exposesMap } from "./virtual_mf-exposes-BCSnz46C.js";
var index_cjs$1 = {};
var polyfills_cjs$1 = {};
function _extends$1() {
...
const importMap = {
  ...
  "react-dom": async () => {
    let pkg = await __vitePreload(() => import("./index-D_9Agc1z.js").then((n) => n.i), true ? [] : void 0);
    return pkg;
  }
};
const usedShared = {
...
var table_microfrontend__mf_v__runtimeInit__mf_v__ = {
  initPromise,
  initResolve,
  initReject
};
async function init(shared = {}) {
  ...
  table_microfrontend__mf_v__runtimeInit__mf_v__.initResolve(initRes);
  return initRes;
}
...
export {
  ...
  getExposes as g,
  index_cjs$1 as i,
  table_microfrontend__mf_v__runtimeInit__mf_v__ as t
};
//# sourceMappingURL=virtual_mf-REMOTE_ENTRY_ID-87HXnLMv.js.map
