import { _ as __vitePreload, e as exposesMap } from "./virtual_mf-exposes-B3VJjEIR.js";
var index_cjs$1 = {};
var polyfills_cjs$1 = {};
function _extends$1() {
...
const importMap = {
  "react": async () => {
    let pkg = await __vitePreload(() => import("./index-DGTCVKxC.js").then((n) => n.i), true ? [] : void 0);
    return pkg;
  },
  "react-dom": async () => {
    let pkg = await __vitePreload(() => import("./index-CMzR9zpY.js").then((n) => n.i), true ? [] : void 0);
    return pkg;
  }
};
const usedShared = {
...
var header_microfrontend__mf_v__runtimeInit__mf_v__ = {
  initPromise,
  initResolve,
  initReject
};
async function init(shared = {}) {
  ...
  header_microfrontend__mf_v__runtimeInit__mf_v__.initResolve(initRes);
  return initRes;
}
...
export {
  init as a,
  getExposes as g,
  header_microfrontend__mf_v__runtimeInit__mf_v__ as h,
  index_cjs$1 as i
};
//# sourceMappingURL=virtual_mf-REMOTE_ENTRY_ID-D1JOLiNh.js.map
