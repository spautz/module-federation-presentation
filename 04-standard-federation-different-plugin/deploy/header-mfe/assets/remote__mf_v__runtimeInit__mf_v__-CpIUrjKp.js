...
const lazyLoaderHookFetch = async (input, init) => {
  ...
  const hook = (url2, init2) => {
    return loaderHooks.lifecycle.fetch.emit(url2, init2);
  };
...
export {
  index_cjs$1 as i,
  remote__mf_v__runtimeInit__mf_v__ as r
};
//# sourceMappingURL=remote__mf_v__runtimeInit__mf_v__-CpIUrjKp.js.map
