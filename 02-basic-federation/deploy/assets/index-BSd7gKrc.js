...
const __federation_var_microfrontendOneApp = await __federation_method_getRemote("microfrontendOne" , "./App");
 let MicrofrontendOne = __federation_method_unwrapDefault(__federation_var_microfrontendOneApp); 
const MicrofrontendTwo = lazy(() => __federation_method_getRemote("microfrontendTwo" , "./App").then(module=>__federation_method_wrapDefault(module, true)));
function App() {
  const [count, setCount] = useState(0);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.header, children: /* @__PURE__ */ jsxRuntimeExports.jsx(MicrofrontendOne, {}) }),
